...
from djangotestapp.reservations.views.order import OrderView
from djangotestapp.reservations.views.orders import OrdersView
from djangotestapp.reservations.views.top_five_customers import TopFiveCustomersView
from djangotestapp.reservations.views.top_five_reserved_products import TopFiveReservedProductsView
